...
import icon from "../pages/assets/Icon.svg";
import person from "../../src/pages/assets/VRPerson.svg";
const Pricing = () => {
  return (
    <div className="flex flex-col w-full ">
      ...
      <div className="bg-[#252532CF] w-full h-[587px] border-white-gradient px-6 py-8 flex flex-row justify-around relative">
        ...
        <img src={person} className="-mb-16"/>
