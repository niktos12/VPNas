...
import comment5 from '../assets/comment5.svg'
import comment6 from '../assets/comment6.svg'
import CommentPopover from "./CommentPopover";
const Testimonial = () => {
  return (
    <div className="relative flex flex-col items-center justify-center mt-24 h-[1247px] w-full">
