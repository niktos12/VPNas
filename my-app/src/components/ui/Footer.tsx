import waves from '../../pages/assets/image 33.svg'
import twitter from "../../pages/assets/1.svg";
import facebook from "../../pages/assets/2 (1).svg";
import instagram from "../../pages/assets/3.svg";
import github from "../../pages/assets/4.svg";
import logo from "../../assets/Frame 22.svg";
import location from "../../pages/assets/Location.svg";
import message from "../../pages/assets/Message.svg";
import calling from "../../pages/assets/Calling.svg";
const Footer = () => {
  return (
